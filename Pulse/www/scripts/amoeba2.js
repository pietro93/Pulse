var amoeba = document.getElementById('amoeba2');
...
function excite() {
    ...
    $("#amoeba :nth-child(odd)").css({ "background": "darkgreen" });
    $("#amoeba > *").animate({
        "opacity":"0.2",
        "border-radius": "1px",
...
function cooldown() {
    ...
    $("#amoeba :nth-child(odd)").css({ "background": "yellow"});
